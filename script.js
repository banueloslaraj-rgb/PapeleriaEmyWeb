...
// ⚡ VERSIÓN ACTUAL
const VERSION = '2.1.1'; // Versión para Papelería Emy
...
function mostrar(lista){
    ...
    if(!lista || lista.length === 0) {
        contenedor.innerHTML = "<p style='text-align:center;'>No hay productos o servicios disponibles</p>"
        return
    }
    ...
    lista.forEach((producto) => {
        ...
        <div class="card">
            ...
            <a href="${producto.video}" target="_blank">🎥 Ver más información</a>
            <br><br>
            <button onclick='agregarAlCarrito(${JSON.stringify(producto).replace(/'/g, "\\'")})'>➕ Agregar</button>
        </div>
        `
    })
}
...
function mostrarFormularioEnvio() {
    ...
    <div class="form-envio">
        <h3>📦 Datos para recoger o envío</h3>
        ...
        <div class="form-group">
            ...
            <input type="tel" id="telefono" placeholder="Ej: 3111198148">
        </div>
        
        <div class="form-group">
            <label>Dirección (si aplica envío) *</label>
